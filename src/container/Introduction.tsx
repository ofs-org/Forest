...
export function Introduction() {
  return (
    <section className="container">
      <div className="max-sm:pt-12 max-sm:px-4 overflow-hidden pb-8 pt-64 px-8 relative rounded-2xl text-white">
        <img
          className="absolute inset-0 object-cover size-full z-10"
          src={floresta}
          alt="Imagem de floresta"
        />
        <div className="absolute bg-gradient-to-t from-verde-950/80 inset-0 z-30" />
